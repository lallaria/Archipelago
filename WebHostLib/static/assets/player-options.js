...
const exportOptions = () => {
  ...
  switch (preset) {
    case '__default':
      options['description'] = `Generated on TreZipelago with the default preset.`;
      break;

    case '__custom':
      options['description'] = `Generated on TreZipelago.`;
      break;

    default:
      options['description'] = `Generated on TreZipelago with the ${preset} preset.`;
  }
