...
Once you have the zip file corresponding to your multiworld, follow [these steps](https://trezapalooza.com/tutorial/Archipelago/setup/en#hosting-an-archipelago-server) to host a room.
