...
ITEM_TABLE: dict[str, SSItemData] = {
    ...
    "Rupoor":               SSItemData("Consumable",   IC.filler,              34,     0,  0x22),
    ...
    "Cursed Medal":                 SSItemData("Item",         IC.filler,              104,    1,  0x68),
    ...
    "Skyview Map":                          SSItemData("Map",          IC.filler,              207,    1,  0xCF),
    "Earth Temple Map":                     SSItemData("Map",          IC.filler,              208,    1,  0xD0),
    "Lanayru Mining Facility Map":          SSItemData("Map",          IC.filler,              209,    1,  0xD1),
    "Ancient Cistern Map":                  SSItemData("Map",          IC.filler,              210,    1,  0xD2),
    "Fire Sanctuary Map":                   SSItemData("Map",          IC.filler,              211,    1,  0xD3),
    "Sandship Map":                         SSItemData("Map",          IC.filler,              212,    1,  0xD4),
    "Sky Keep Map":                         SSItemData("Map",          IC.filler,              213,    1,  0xD5),
