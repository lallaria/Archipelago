...
ITEM_TABLE: dict[str, TPItemData] = {
    ...
    "Empty Bottle (Fishing Hole)": TPItemData("Bottle", IC.useful, 46, 1, 0x60),
    "Milk (half) (Sera Bottle)": TPItemData("Bottle", IC.useful, 47, 1, 0x65),
    "Lantern Oil (Coro Bottle)": TPItemData("Bottle", IC.useful, 48, 1, 0x9D),
    "Great Fairy Tears (Jovani)": TPItemData("Bottle", IC.useful, 49, 1, 0x75),
    ...
    "Progressive Sky Book": TPItemData("Item", IC.progression, 123, 1, 0xE9),
