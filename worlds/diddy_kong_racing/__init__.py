...
from .DoorShuffle import get_door_unlock_requirements, place_vanilla_door_unlock_items, shuffle_door_unlock_items, \
    place_door_unlock_items
...
class DiddyKongRacingWorld(World):
    ...
    # For Universal Tracker, doesn't get called in standard gen
