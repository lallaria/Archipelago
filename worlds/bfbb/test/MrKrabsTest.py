...
class MrKrabsSOTest(BfBBTestBase):
    ...
    def test_access_without_lvl_items(self):
        self.collect_by_name(ItemNames.spat)
        #self.collect_by_name(ItemNames.lvl_itm_jf)
        loc = LocationNames.spat_jf_08
        self.assertTrue(self.can_reach_location(loc), f"{loc} can't be reached with.")