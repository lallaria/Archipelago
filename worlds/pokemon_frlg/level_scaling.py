...
def create_scaling_data(world: "PokemonFRLGWorld"):
    ...
    trainer_data = {
        ...
        "Route 10 - Power Plant": [{"name": "PokeManiac Mark", "data_ids": ["TRAINER_POKEMANIAC_MARK"]}],
        ...
        "Rocket Hideout B1F": [{"name": "Team Rocket Grunt 8", "data_ids": ["TRAINER_TEAM_ROCKET_GRUNT_8"]},
        ...
        "Celadon Gym Trainers": [{"name": "Celadon Gym Trainers", "connections": ["Celadon Gym", "Celadon Gym - Tree"],
        ...
        "Route 12 - Tree N": [{"name": "Camper Justin", "data_ids": ["TRAINER_CAMPER_JUSTIN"]}],
        ...
        "Silph Co. 2F - Southwest": [{"name": "Scientist Connor", "data_ids": ["TRAINER_SCIENTIST_CONNOR"]}],
        "Silph Co. 3F": [{"name": "Team Rocket Grunt 25", "data_ids": ["TRAINER_TEAM_ROCKET_GRUNT_25"]}],
        "Silph Co. 3F - West": [{"name": "Scientist Jose", "data_ids": ["TRAINER_SCIENTIST_JOSE"]}],
        ...
        "Silph Co. 4F - North": [{"name": "Scientist Rodney", "data_ids": ["TRAINER_SCIENTIST_RODNEY"]}],
        ...
        "Silph Co. 7F - Northwest": [{"name": "Silph Co. Rival", "data_ids": ["TRAINER_RIVAL_SILPH_BULBASAUR",
                                                                              "TRAINER_RIVAL_SILPH_CHARMANDER",
                                                                              "TRAINER_RIVAL_SILPH_SQUIRTLE"]}],
        "Silph Co. 7F - Southeast": [{"name": "Team Rocket Grunt 34", "data_ids": ["TRAINER_TEAM_ROCKET_GRUNT_34"]}],
        ...
        "Silph Co. 9F - Northwest": [{"name": "Team Rocket Grunt 37", "data_ids": ["TRAINER_TEAM_ROCKET_GRUNT_37"]}],
        ...
        "Silph Co. 11F - President": [{"name": "Boss Giovanni 2", "data_ids": ["TRAINER_BOSS_GIOVANNI_2"]}],
        ...
        "Saffron Gym Trainers": [{"name": "Saffron Gym Trainers",
                                  "connections": ["Saffron Gym - Northwest", "Saffron Gym - North",
                                                  "Saffron Gym - Northeast", "Saffron Gym - West",
                                                  "Saffron Gym - Center", "Saffron Gym - East",
        ...
        "Route 20 - Cave S": [{"name": "Picnicker Irene", "data_ids": ["TRAINER_PICNICKER_IRENE"]}],
        ...
        "Victory Road 3F - Southeast": [{"name": "Cool Couple Ray & Tyra",
                                         "data_ids": ["TRAINER_COOL_COUPLE_RAY_TYRA"]}],
        ...
        "Kindle Road - Water S": [{"name": "Swimmer Abigail", "data_ids": ["TRAINER_SWIMMER_FEMALE_ABIGAIL"]}],
        ...
        "Kindle Road - Water N": [{"name": "Swimmer Finn", "data_ids": ["TRAINER_SWIMMER_MALE_FINN"]},
        ...
        "Resort Gorgeous - Resort": [{"name": "Lady Jacki", "data_ids": ["TRAINER_LADY_JACKI"]},
        ...
        "Lost Cave Room 1": [{"name": "Ruin Maniac Lawson", "data_ids": ["TRAINER_RUIN_MANIAC_LAWSON"]}],
        "Lost Cave Room 4": [{"name": "Psychic Laura", "data_ids": ["TRAINER_PSYCHIC_LAURA"]}],
        "Lost Cave Room 10": [{"name": "Lady Selphy", "data_ids": ["TRAINER_LADY_SELPHY"]}],
        ...
        "Tanoby Ruins - Scufib Chamber": [{"name": "Ruin Maniac Brandon", "data_ids": ["TRAINER_RUIN_MANIAC_BRANDON"]}],
        "Tanoby Ruins - Weepth Chamber": [{"name": "Gentleman Clifford", "data_ids": ["TRAINER_GENTLEMAN_CLIFFORD"]},
                                          {"name": "Painter Edna", "data_ids": ["TRAINER_PAINTER_EDNA"]}],
        "Tanoby Ruins - Monean Chamber": [{"name": "Ruin Maniac Benjamin",
    ...
    wild_encounter_data = {
        ...
        "Safari Zone Center - Land Encounters": [{"name": "Safari Zone Center Land Scaling", "type": "Land",
                                                  "data_ids": ["MAP_SAFARI_ZONE_CENTER"]}],
        "Safari Zone East - Land Encounters": [{"name": "Safari Zone East Land Scaling", "type": "Land",
                                                "data_ids": ["MAP_SAFARI_ZONE_EAST"]}],
        "Safari Zone North - Land Encounters": [{"name": "Safari Zone North Land Scaling", "type": "Land",
                                                 "data_ids": ["MAP_SAFARI_ZONE_NORTH"]}],
        "Safari Zone West - Land Encounters": [{"name": "Safari Zone West Land Scaling", "type": "Land",
        ...
        "Mt. Ember Ruby Path B1F Stairs - Land Encounters": [{"name": "Mt. Ember Ruby Path B1F Stairs Land Scaling",
                                                              "type": "Land",
        ...
        "Mt. Ember Ruby Path B2F Stairs - Land Encounters": [{"name": "Mt. Ember Ruby Path B2F Stairs Land Scaling",
                                                              "type": "Land",
        ...
        "Icefall Cave Entrance - Land Encounters": [{"name": "Icefall Cave Entrance Land Scaling", "type": "Land",
        ...
        "Lost Cave Room 1 - Land Encounters": [{"name": "Lost Cave Room 1 Land Scaling", "type": "Land",
                                                "data_ids": ["MAP_FIVE_ISLAND_LOST_CAVE_ROOM1"]}],
        "Lost Cave Room 2 - Land Encounters": [{"name": "Lost Cave Room 2 Land Scaling", "type": "Land",
                                                "data_ids": ["MAP_FIVE_ISLAND_LOST_CAVE_ROOM2"]}],
        "Lost Cave Room 3 - Land Encounters": [{"name": "Lost Cave Room 3 Land Scaling", "type": "Land",
                                                "data_ids": ["MAP_FIVE_ISLAND_LOST_CAVE_ROOM3"]}],
        "Lost Cave Room 4 - Land Encounters": [{"name": "Lost Cave Room 4 Land Scaling", "type": "Land",
                                                "data_ids": ["MAP_FIVE_ISLAND_LOST_CAVE_ROOM4"]}],
        "Lost Cave Room 5 - Land Encounters": [{"name": "Lost Cave Room 5 Land Scaling", "type": "Land",
                                                "data_ids": ["MAP_FIVE_ISLAND_LOST_CAVE_ROOM5"]}],
        "Lost Cave Room 6 - Land Encounters": [{"name": "Lost Cave Room 6 Land Scaling", "type": "Land",
                                                "data_ids": ["MAP_FIVE_ISLAND_LOST_CAVE_ROOM6"]}],
        "Lost Cave Room 7 - Land Encounters": [{"name": "Lost Cave Room 7 Land Scaling", "type": "Land",
                                                "data_ids": ["MAP_FIVE_ISLAND_LOST_CAVE_ROOM7"]}],
        "Lost Cave Room 8 - Land Encounters": [{"name": "Lost Cave Room 8 Land Scaling", "type": "Land",
                                                "data_ids": ["MAP_FIVE_ISLAND_LOST_CAVE_ROOM8"]}],
        "Lost Cave Room 9 - Land Encounters": [{"name": "Lost Cave Room 9 Land Scaling", "type": "Land",
                                                "data_ids": ["MAP_FIVE_ISLAND_LOST_CAVE_ROOM9"]}],
        "Lost Cave Room 10 - Land Encounters": [{"name": "Lost Cave Room 10 Land Scaling", "type": "Land",
                                                 "data_ids": ["MAP_FIVE_ISLAND_LOST_CAVE_ROOM10"]}],
        "Lost Cave Room 11 - Land Encounters": [{"name": "Lost Cave Room 11 Land Scaling", "type": "Land",
                                                 "data_ids": ["MAP_FIVE_ISLAND_LOST_CAVE_ROOM11"]}],
        "Lost Cave Room 12 - Land Encounters": [{"name": "Lost Cave Room 12 Land Scaling", "type": "Land",
                                                 "data_ids": ["MAP_FIVE_ISLAND_LOST_CAVE_ROOM12"]}],
        "Lost Cave Room 13 - Land Encounters": [{"name": "Lost Cave Room 13 Land Scaling", "type": "Land",
                                                 "data_ids": ["MAP_FIVE_ISLAND_LOST_CAVE_ROOM13"]}],
        "Lost Cave Room 14 - Land Encounters": [{"name": "Lost Cave Room 14 Land Scaling", "type": "Land",
        ...
        "Route 25 - Water Encounters": [{"name": "Route 25 Water Scaling", "type": "Water",
                                         "data_ids": ["MAP_ROUTE25"]}],
        ...
        "Route 10 - Water Encounters": [{"name": "Route 10 Water Scaling", "type": "Water",
                                         "data_ids": ["MAP_ROUTE10"]}],
        ...
        "Safari Zone Center - Water Encounters": [{"name": "Safari Zone Center Water Scaling", "type": "Water",
                                                   "data_ids": ["MAP_SAFARI_ZONE_CENTER"]}],
        "Safari Zone East - Water Encounters": [{"name": "Safari Zone East Water Scaling", "type": "Water",
                                                 "data_ids": ["MAP_SAFARI_ZONE_EAST"]}],
        "Safari Zone North - Water Encounters": [{"name": "Safari Zone North Water Scaling", "type": "Water",
                                                  "data_ids": ["MAP_SAFARI_ZONE_NORTH"]}],
        "Safari Zone West - Water Encounters": [{"name": "Safari Zone West Water Scaling", "type": "Water",
                                                 "data_ids": ["MAP_SAFARI_ZONE_WEST"]}],
        ...
        "Seafoam Islands B4F - Water Encounters": [{"name": "Seafoam Islands B4F Water Scaling", "type": "Water",
                                                    "data_ids": ["MAP_SEAFOAM_ISLANDS_B4F"]}],
        "Route 23 - Water Encounters": [{"name": "Route 23 Water Scaling", "type": "Water",
                                         "data_ids": ["MAP_ROUTE23"]}],
        ...
        "Icefall Cave Entrance - Water Encounters": [{"name": "Icefall Cave Entrance Water Scaling", "type": "Water",
                                                      "data_ids": ["MAP_FOUR_ISLAND_ICEFALL_CAVE_ENTRANCE"]}],
        ...
        "Fishing Encounters": [{"name": "Fishing Scaling", "type": "Fishing",
                                "connections": ["Pallet Town - Fishing Encounters",
                                                ...
                                                "Safari Zone Center - Fishing Encounters",
                                                "Safari Zone East - Fishing Encounters",
                                                "Safari Zone North - Fishing Encounters",
                                                "Safari Zone West - Fishing Encounters",
                                                "Seafoam Islands B3F - Fishing Encounters",
                                                "Seafoam Islands B4F - Fishing Encounters",
                                                "Berry Forest - Fishing Encounters",
                                                "Icefall Cave Entrance - Fishing Encounters",
                                                ...
                                                "Kindle Road - Fishing Encounters",
                                                "Cape Brink - Fishing Encounters",
                                                "Bond Bridge - Fishing Encounters",
                                                "Four Island Town - Fishing Encounters",
                                                ...
                                                "Resort Gorgeous - Fishing Encounters",
                                                "Water Path - Fishing Encounters",
                                                "Ruin Valley - Fishing Encounters",
                                                "Green Path - Fishing Encounters",
                                                "Outcast Island - Fishing Encounters",
                                                "Tanoby Ruins - Fishing Encounters",
    ...
    static_encounter_data = {
        ...
        "Route 12 - Snorlax": [{"name": "Static Snorlax 1", "data_ids": ["STATIC_POKEMON_ROUTE12_SNORLAX"]}],
        "Route 16 - Snorlax": [{"name": "Static Snorlax 2", "data_ids": ["STATIC_POKEMON_ROUTE16_SNORLAX"]}],
        "Saffron Dojo": [{"name": "Gift Hitmonchan", "data_ids": ["GIFT_POKEMON_HITMONCHAN"]},
                         {"name": "Gift Hitmonlee", "data_ids": ["GIFT_POKEMON_HITMONLEE"]}],
        "Silph Co. 7F - Northwest": [{"name": "Gift Lapras", "data_ids": ["GIFT_POKEMON_LAPRAS"]}],
        "Seafoam Islands B4F - Articuno": [{"name": "Legendary Articuno", "data_ids": ["LEGENDARY_POKEMON_ARTICUNO"]}],
        "Cinnabar Pokemon Lab Experiment Room": [{"name": "Gift Omanyte",
        ...
        "Mt. Ember Summit - Moltres": [{"name": "Legendary Moltres", "data_ids": ["LEGENDARY_POKEMON_MOLTRES"]}],
