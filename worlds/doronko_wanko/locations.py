...
doronko_wanko_locations: List[LocationInfo] = [
    ...
    {"name":"Relaxing room!","id":base_id + 80,"inGameId":"RelaxingRoom","badge": True},
    {"name":"Muddy basement!","id":base_id + 81,"inGameId":"MuddyBasement","badge": True},
    ...
    {"name":"A vintage pome","id":base_id + 88,"inGameId":"AVintagePome","badge": True},
    {"name":"'99 POME","id":base_id + 89,"inGameId":"99POME","badge": True},
    {"name":"I dominated wine cellar!","id":base_id + 90,"inGameId":"IDominatedWineCeller","badge": True},
    # Either temperature panel can trigger this
    {"name":"DO NOT PRESS","id":base_id + 91,"inGameId":"DONOTPRESS","badge": True},
    {"name":"Temperature Control is important","id":base_id + 92,"inGameId":"TotalDamage1000","badge": True},
