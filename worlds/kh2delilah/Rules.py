...
if TYPE_CHECKING:
    from . import KH2DelilahWorld
else:
    KH2DelilahWorld = object

# Shamelessly Stolen from Messanger

class KH2DelilahRules:
    player: int
    world: KH2DelilahWorld
    ...
    def __init__(self, world: KH2DelilahWorld) -> None:
...
class KH2DelilahWorldRules(KH2DelilahRules):
    def __init__(self, kh2delilahworld: KH2DelilahWorld) -> None:
        # These Rules are Always in effect
        super().__init__(kh2delilahworld)
        self.region_rules = {
...
class KH2FormRules(KH2DelilahRules):
...
class KH2FightRules(KH2DelilahRules):
    player: int
    world: KH2DelilahWorld
