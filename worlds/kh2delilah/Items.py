...
Wincon_Table = {
    ItemName.LuckyEmblem: ItemData(kh2delilahid=367, memaddr=0x3641),  # letter item
    # ItemName.Victory:     ItemData(kh2delilahid=263, memaddr=0x111),
    ItemName.Bounty:      ItemData(kh2delilahid=461, memaddr=0x365E),  # Dummy 14
...
# Have to use the kh2delilahid for checking stuff that sora has equipped
