...
from .Regions import KH2DELILAHREGIONS
...
exclusion_table = {
    ...
    "Hitlist":       {
        ...
        LocationName.VexenDataLostIllusion:             9,
        LocationName.LarxeneDataLostIllusion:           9,  
        LocationName.MarluxiaDataLostIllusion:          9,
        LocationName.LexaeusDataLostIllusion:           9,
        LocationName.ZexionDataLostIllusion:            9,
        LocationName.XemnasDataPowerBoost:              8,
        LocationName.AxelDataMagicBoost:                8,
        LocationName.RoxasDataMagicBoost:               8,
        LocationName.SaixDataDefenseBoost:              8,
        LocationName.DemyxDataAPBoost:                  8,
        LocationName.LuxordDataAPBoost:                 8,
        LocationName.XaldinDataDefenseBoost:            8,
        LocationName.XigbarDataDefenseBoost:            8,
        LocationName.SephirothFenrir:                   8,
        LocationName.TransporttoRemembrance:            8,
        LocationName.MarluxiaASEternalBlossom:          7,
        LocationName.LarxeneASCloakedThunder:           7,
        LocationName.VexenASRoadtoDiscovery:            7,            
        LocationName.LexaeusASStrengthBeyondStrength:   7,
        LocationName.ZexionASBookofShadows:             7,
...
location_groups = {
    ...
    for Region_Name, Region_Locs in KH2DELILAHREGIONS.items() if Region_Locs and "Event" not in Region_Locs[0]
}
