...
This is the AP World for Paper Mario 64 to be used in [Archipelago.](https://trezapalooza.com/) It is in a playable, **alpha** state. Some things will work, some things will not. Things that do work might not work in a way that you would expect from a fully completed AP World. 
