...
- **Version:** 0.0.3
- **Source ref:** `0.0.3`
- **Built:** 2026-05-03 23:08 UTC

## Install

```
pip install git+https://github.com/lallaria/Archipelago.git@wheel/worlds/khddd/0.0.3
```
...
- The `wheel/worlds/khddd/0.0.3` **tag** is immutable — pin
  to it for reproducibility. Pinning to the branch tip
  (`wheel/worlds/khddd`) gets the latest published version.
- Source for this build lives at `0.0.3` on the default branch.
