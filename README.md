...
- **Version:** 0.0.7
- **Source ref:** `0.0.7`
- **Built:** 2026-05-04 00:23 UTC

## Install

```
pip install git+https://github.com/lallaria/Archipelago.git@wheel/worlds/khddd/0.0.7
```
...
- The `wheel/worlds/khddd/0.0.7` **tag** is immutable — pin
  to it for reproducibility. Pinning to the branch tip
  (`wheel/worlds/khddd`) gets the latest published version.
- Source for this build lives at `0.0.7` on the default branch.
