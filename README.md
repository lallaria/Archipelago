...
- **Version:** 0.0.4
- **Source ref:** `0.0.4`
- **Built:** 2026-05-03 23:26 UTC

## Install

```
pip install git+https://github.com/lallaria/Archipelago.git@wheel/worlds/khddd/0.0.4
```
...
- The `wheel/worlds/khddd/0.0.4` **tag** is immutable — pin
  to it for reproducibility. Pinning to the branch tip
  (`wheel/worlds/khddd`) gets the latest published version.
- Source for this build lives at `0.0.4` on the default branch.
