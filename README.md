...
- **Version:** 0.0.11
- **Source ref:** `0.0.11`
- **Built:** 2026-05-04 20:54 UTC

## Install

```
pip install git+https://github.com/lallaria/Archipelago.git@wheel/worlds/khddd/0.0.11
```
...
- The `wheel/worlds/khddd/0.0.11` **tag** is immutable — pin
  to it for reproducibility. Pinning to the branch tip
  (`wheel/worlds/khddd`) gets the latest published version.
- Source for this build lives at `0.0.11` on the default branch.
